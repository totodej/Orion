...
public class AuthController {
	...
	/*
	 Enregistre un nouvel utilisateur et retourne un token JWT immédiatement
	*/
	...
	*/
	...
	/*
	 Met à jour les informations de l'utilisateur connecté et retourne un nouveau token JWT
	 */
	@PutMapping("/me")
